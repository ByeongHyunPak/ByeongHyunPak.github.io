...
export const experienceData: Experience[] = [
  ...
  //   points: [
  //     "Selected as one of 20 research officers nationwide (1 of 4 in CSE) dedicated to STEM research for national defense",
  //   ]
  // },
  {
    date: "Mar 2023 – Present",
    ...
    points: [
      ...
      "Developed object detection models for surveillance UAVs",
      "Worked on domain generalization with vision-language models [ECCV 2024]",
      "Worked on image & video diffusion models [NeurIPS 2025]",
    ]
  },
  {
    ...
    points: [
      "Worked on implicit neural representations (INRs) for super-resolution [CVPR 2023]",
